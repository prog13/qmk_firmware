...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  _______,  HS_DIR,   KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   KC_USB,   _______,  RL_MOD,   _______,  _______,  _______,  _______,  _______, 
        _______,  _______, _______,  _______,  _______,   KC_LED,  _______,  _______,  _______,  RGB_TOG,  _______,  _______,  _______,  _______,  
        _______,           _______,  _______,  KC_CALC,  _______,  NK_TOGG,  _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MODE,  MO(_FBL),  RGB_VAI, 
        _______,  GU_TOGG, _______,                                HS_BATQ,                       _______,           _______,  RGB_SAI,   RGB_VAD,  RGB_SAD),

    [_MBL] = LAYOUT( /* Base */
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTL,  HS_SIRI,  _______,  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_DEL,   KC_HOME,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  KC_END,   
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_PGUP,
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,   KC_PGDN,        
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,   
        KC_LCTL,  KC_LALT,  KC_LCMD,                                KC_SPC,                       KC_RGUI,            MO(_MFL), KC_LEFT,  KC_DOWN,  KC_RGHT ),
    ...
    [_MFL] = LAYOUT( /* Base */
        ...
        _______,  _______,  _______,  _______,  _______,  KC_LED,  _______,  _______,  _______,   RGB_TOG,  _______,  _______, _______,  _______, 
        _______,            _______,  _______,  KC_CALC,  _______,  NK_TOGG,  _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MODE,  MO(_FBL), RGB_VAI,  
        _______,  _______,  _______,                                HS_BATQ,                      _______,            _______,  RGB_SAI,  RGB_VAD,  RGB_SAD ),
    [_FBL] = LAYOUT( /* Base */ 
